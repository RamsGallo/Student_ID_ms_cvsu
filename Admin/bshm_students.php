       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Bachelor of Science in Hospitality Management</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item"><a href="./createStudents.php">Manage Students</a></li>
              <li class="breadcrumb-item active" aria-current="page">BSHM Students</li>
            </ol>
          </div>
          ...
          <div>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Showing all records of BSHM students</h6>
                </div>
                <div class="table-responsive p-3">
                  ...
                  <?php
                      ...
                      WHERE tblclass.className IN ('Bachelor of Science in Hospitality Management','BSHM','bshm','bachelor of science in hospitality management')";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
