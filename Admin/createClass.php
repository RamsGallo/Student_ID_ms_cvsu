  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $queryClassName = $conn->query("SELECT * FROM tblclass WHERE Id='$Id'")->fetch_array()['className'];

        $query1 = mysqli_query($conn, "INSERT INTO tblclassarchive(id,className) VALUES ('$Id', '$queryClassName')");
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a onClick=\"javascript: return confirm('This will be moved to the program archive. Do you wish to remove this program?');\" href='?action=delete&Id=".$rows['Id']."'><i class='fas fa-fw fa-trash'></i>Delete</a></td>
                              </tr>";
                          }
                      }
                      else
